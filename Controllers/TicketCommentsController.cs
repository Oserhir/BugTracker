...
namespace TheBugTracker.Controllers
{
    public class TicketCommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Commend,Created,TicketId,UserId")] TicketComment ticketComment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Commend,Created,TicketId,UserId")] TicketComment ticketComment)
        {
