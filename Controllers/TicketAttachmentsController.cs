...
namespace TheBugTracker.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Created,UserId,Description,FileName,FileData,FileContentType,TicketId")] TicketAttachment ticketAttachment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Created,UserId,Description,FileName,FileData,FileContentType,TicketId")] TicketAttachment ticketAttachment)
        {
